			...
			<span id="idch"></span><br>-->
							...
							<tr>
								...
								<td><span><input type="text" name="mname" id="mname"
										value="" size="15" style="width: 100%"></span></td>
							</tr>
							<tr>
							...
							<td width="5"></td>
							<td>
							<span><input type="date" name="mbirth"id="mbirth"  maxlength="10" size="15" style="width:50%;"></span>
							</td>
							</tr>
							...
							<th>자기소개<span class="join_required">*</span></th>
								<td width="5"></td>
								<td><span>
								 <textarea rows="10" cols="50" name="mcontents" id="mcontents"></textarea><br>
                                 </span></td>
							</tr>
							
							<tr>
							<th>프로필 사진 <span class="join_required">*</span></th>
								<td width="5"></td>
								<td><span><input type="file" name="mfile" id="mfile"></span> </td>
					...
					<input type="hidden" name="mclass" id="mclass" value="트레이너">
