...
<div class="main" id="section1">
	<form action="boardupdateprocess" method="post" name="boardupdateform">
		<div class="wrap">
			<div class="board_update_view">
				<div class="header">
					<div class="tit">글 수정</div>
					<div class="utils">
						<div class="view_back">
							<button class="btn_back_list" onclick="boardList()">
								<span class="txt">목록으로 돌아가기</span>
							</button>
							<button class="btn_write" onclick="boardUpdate()">수정하기</button>
						</div>
					</div>
				</div>
				<div class="content">
					<div class="write_wrap">
						<div class="editor" id="editor">
							<p class="title">
								<strong>제목</strong>
								<input type="text" class="atitle" id="atitle" value="${boardUpdate.atitle}" name="atitle">
								<input type="hidden" name="amid" id="amid" value="${boardUpdate.amid}" readonly>
								<input type="hidden" name="anum" value="${boardUpdate.anum}" readonly>
								<span class="awriter">
									${boardUpdate.amid}
								</span>
								<span class="number">
									글번호 ${boardUpdate.anum}
								</span>
							</p>	
						</div>
					</div>
				...
				<div class="edWSec">
					<textarea class="editWindow" name="acontents" id="acontents" rows="10" cols="50" >${boardUpdate.acontents}</textarea>
				</div>
			</div>
		</div>
	</form>
...
<script>
	...
	function boardList(){
		location.href="boardlistpaging?atype=${boardUpdate.atype}";
	}
</script>
