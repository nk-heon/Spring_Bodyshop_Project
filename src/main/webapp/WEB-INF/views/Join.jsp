...
<section class="banner" role="banner">
	<div id="mySidenav" class="sidenav">
  		...
  		<div class="cboth section" style = "text-align: center;">
			<div class="dropdown">
  				<button  onclick="location.href='Join'"  class="dropbtn" style = "font-size: 25px;">회원가입</button>
...
<div class="member_wrap">
	...
	<h1>
	<a href=""  class="relative">
						<img src="resources/images/ftr_home.png" width="40" height="25" vspace="2">					
					</a><span>회원가입</span>
	</h1>
	</header>
	<div class="join_main">
	...
	<a><button type="button" onclick="location.href='sellermemberjoinform'"class="btn_go_join" onclick="rakeLog.sendRakeLog(this);" data-log-actionid-area="business_buy_member" data-log-actionid-label="join" data-is-ab-send="1">회원가입</button>
	</a>
	</li>
<!-- 일반회원 -->
	<li>
	...
	<a><button type="button" onclick="location.href='generalmemberjoinform'"class="btn_go_join" onclick="rakeLog.sendRakeLog(this);" data-log-actionid-area="business_buy_member" data-log-actionid-label="join" data-is-ab-send="1">회원가입</button>
	</a>
	<h3>카카오로 로그인</h3>
 <a href="kakaologin">
...
<a href="naverlogin">
   <img src="${pageContext.request.contextPath}/resources/img/네이버 아이디로 로그인_축약형_Green.png/">
	...
	<a><button type="button" onclick="location.href='trainermemberjoinform'"class="btn_go_join" onclick="rakeLog.sendRakeLog(this);" data-log-actionid-area="business_buy_member" data-log-actionid-label="join" data-is-ab-send="1">회원가입</button>
	</a>
	</li>
	</ul>
	</div>
